...
const SocialLink = ({ icon, platform, href }) => (
  ...
  >
    <div className="size-8 rounded-md bg-slate-100 dark:bg-slate-800 flex items-center justify-center group-hover:bg-[#0d59f2] group-hover:text-white transition-colors">
